...
if algorithm == "PPO":
    ...
    model = SAC.load("Key_Door_Goal_Environment/agents/SAC/models/SAC-trunc1000_CSCA_dist/agent_19/SAC_step_1000000")
elif algorithm == "TD3":
...
dbscan = DBSCAN(eps=0.71, min_samples=52)
...
def calculate_patterns(states, labels, n_clusters):
    patterns = {
        "[x, y, 1, 1, 1]": [1, 1, 1],
        "[x, y, 1, 0, 0]": [1, 0, 0],
        "[x, y, 0, 0, 0]": [0, 0, 0],
...
calculate_patterns(valid_dbscan_states, valid_dbscan_labels, n_dbscan_clusters)
