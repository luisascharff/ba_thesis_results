...
min_samples_values = np.arange(5, 3000, 10)
...
four_cluster_results = results_df[results_df['num_clusters'] == 3]
...
print(f"Percentage of results with 3 clusters: {percentage_four_clusters:.2f}%")
print(f"Mean silhouette score for 3 clusters: {mean_silhouette:.2f}")
print(f"Min silhouette score for 3 clusters: {min_silhouette:.2f}")
print(f"Max silhouette score for 3 clusters: {max_silhouette:.2f}")

print(f"Mean min_samples for 3 clusters: {mean_min_samples:.2f}")
print(f"Min min_samples for 3 clusters: {min_min_samples}")
print(f"Max min_samples for 3 clusters: {max_min_samples}")

print(f"Mean eps for 3 clusters: {mean_eps:.2f}")
print(f"Min eps for 3 clusters: {min_eps:.2f}")
print(f"Max eps for 3 clusters: {max_eps:.2f}")
